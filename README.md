...
the primary framework while external shapes stay compatibility inputs. The
result renders a `workflow_target_profile_matrix` report/action card with
exportable summary, profile evidence, and replay-lock artifacts.
