...
`agent-learn run`, `agent-learn eval`, and `agent-learn optimize-eval` write
Agent Learning Kit artifact kinds (`agent-learning.run.v1`,
`agent-learning.eval.v1`, and `agent-learning.eval-optimization.v1`) plus
