...
| 10 | [Evaluate Agent Simulation Reports](10_agent_report_evaluation.py) | Score simulate-sdk-style traces, tools, memory, artifacts, browser/CUA trace coverage, voice, environment injection, and pentest failures | No |
...
- **Cookbook 10**: Evaluate full agent simulation reports locally: trajectory score, tool use, prompt-injection resistance, environment-injection resistance, memory integrity, artifact coverage, browser/CUA action safety, browser trace coverage, voice turn-taking, and expected state
