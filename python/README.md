...
evidence, tool calls, artifacts, events, metadata keys, and errors. Framework transcript quality checks LangChain/LangGraph-style
...
critique, synthesis, steward simplification, and selected best-candidate score.
