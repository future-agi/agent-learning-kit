...
| **Agents** | `AgentReportEvaluator`, `evaluate_agent_report`, trajectory score, tool selection, action safety, prompt-injection resistance, environment-injection resistance, memory integrity, browser/CUA safety, browser trace coverage, voice turn-taking, artifact coverage, state goal accuracy |
