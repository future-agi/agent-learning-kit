...
_API_KEY_ENV = ("AGENT_LEARNING_API_KEY", "FUTURE_AGI_API_KEY", "FI_API_KEY")
_SECRET_KEY_ENV = ("AGENT_LEARNING_SECRET_KEY", "FUTURE_AGI_SECRET_KEY", "FI_SECRET_KEY")
_API_URL_ENV = ("AGENT_LEARNING_API_URL", "FUTURE_AGI_API_URL")
