...
def format_voice_persona(
    ...
    *,
    ...
    rules_section += f"14. **Silent On Hold:** When the agent only says it is checking or asks you to wait, and asks you nothing, your whole reply is the single word {HOLD_MARKER}. Nobody hears it; it is how you stay quiet. Answer normally once the agent speaks again. Being transferred or told goodbye is not a hold: close the call in one turn.\n"
