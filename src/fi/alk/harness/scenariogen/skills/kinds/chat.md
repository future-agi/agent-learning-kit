...
- **The whole request arrives in one wall of text.** Order number, dates, three questions and a
...
- **The person edits themselves.** "order 4471 -- sorry, 4417." The corrected value is the real
  one, and an agent that takes the first fails.
...
- **Ambiguity that a voice caller would resolve by tone.** "great, that's just what I needed" from
...
Message boundaries matter. One thought split across three messages, or three thoughts in one
...
Never tell the person what the agent should reply. Give them what they want, what they know and how
hard they will push.
