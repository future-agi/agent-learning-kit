...
def opening(
    ...
    return (
        ...
        "its complete payload in environment_arguments; never pretend the model supplied internal "
        "identifiers, resolved locations, computed prices, or other hidden state. Treat every "
        "contract phrase like "
