...
def planning_tools(
    ...
    *,
    ...
    @tool(
        ...
        "An angle says what is worth testing, never how it goes. 'a price boundary the caller "
        "disputes' "
        ...
        "Give each angle a `why_hard`: the structural thing under test, like `rule:<name>`, "
