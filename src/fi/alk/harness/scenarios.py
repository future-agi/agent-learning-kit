    ...
    return {
        WRITER: WorkerSpec(
            ...
            instructions=(
                ...
                "given. Write only what your brief names, and stay out of theirs: a scenario "
                "that strays is either a duplicate of somebody else's or a gap in yours. The "
                "names already taken come back with every submission.\n\n"
