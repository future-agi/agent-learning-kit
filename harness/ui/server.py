...
Run from the harness project, with the same environment the CLI uses. The last two variables are what
...
from agent_harness import sessions  # noqa: E402
from agent_harness.chat import Conversation  # noqa: E402
from agent_harness.config import chosen_model, credentials_hint  # noqa: E402
from agent_harness.run import run_suite  # noqa: E402
from agent_harness.scenarios import load as load_scenarios  # noqa: E402
from agent_harness.understand import load as load_contract  # noqa: E402
from agent_harness.world.snapshot import restore as restore_world  # noqa: E402
from agent_harness.world.snapshot import saved as world_saved  # noqa: E402
...
def _adopt(session: sessions.Session) -> None:
    ...
    from agent_harness.sources import resolve
...
async def scenarios():
    ...
    shown as unknown.
    """
    from agent_harness.catalogue import load_catalogue
    from agent_harness.folder import folder_for
...
async def subgoals():
    ...
    from agent_harness.catalogue import load_catalogue
    from agent_harness.simulator import load_simulator_prompt
...
async def simulations():
    ...
    """
    from agent_harness.run.simulation import every_run
...
async def simulation(run_id: str):
    ...
    from agent_harness.run.simulation import read_run
...
async def recording(run_id: str, scenario: str, track: str = ""):
    ...
    """
    from agent_harness.run.simulation import run_root
