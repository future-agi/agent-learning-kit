...
| M3 | Native AgentOptimizer evidence scoring | `native_optimizer_evidence_components`, `generic_target_optimizer_readiness`, `optimizer_governance_readiness`, `optimizer_portfolio_readiness`, `world_hooks_readiness` |
